...
#[derive(Clone)]
pub struct CreateFrequencyPresetController {
    // repo: Rc<dyn mvc::traits::DateTimeRepository>,
    back_callback: Rc<Callback<(), ()>>,
}

impl CreateFrequencyPresetController {
...
mod tests {
    ...
    fn test_controller() -> CreateFrequencyPresetController {
        // CreateFrequencyPresetController::new(MockDateTimeRepository::new(
        //     DateModel { year: 2024, month: 6, day: 12 },
        //     TimeModel { hour: 13, minute: 30, second: 29 },
        //     15,
        // ))
        CreateFrequencyPresetController::new()
    }
