...
#[derive(Clone)]
pub struct CreatePowerPresetController {
    // repo: Rc<dyn mvc::traits::DateTimeRepository>,
    back_callback: Rc<Callback<(), ()>>,
}

impl CreatePowerPresetController {
...
mod tests {
    ...
    fn test_controller() -> CreatePowerPresetController {
        // CreatePowerPresetController::new(MockDateTimeRepository::new(
        //     DateModel { year: 2024, month: 6, day: 12 },
        //     TimeModel { hour: 13, minute: 30, second: 29 },
        //     15,
        // ))
        CreatePowerPresetController::new()
    }
