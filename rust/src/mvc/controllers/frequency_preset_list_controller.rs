...
impl FrequencyPresetListController {
    ...
    pub fn preset_model(&self) -> ModelRc<mvc::FrequencyPresetModel> {
    ...
    pub fn get_preset(&self, index: usize) -> Option<mvc::FrequencyPresetModel> {
    ...
    pub fn update_preset(&self, index: usize, preset_name: &str, preset_desc: &str, freq1: f32, freq2: f32, freq3: &str) {
        ...
        let freq3_csv = crate::ui::create_frequency_preset_adapter::string_to_float_list(freq3);
        self.preset_model.update_preset(index, mvc::FrequencyPresetModel {
            frequency_preset_name: preset_name.into(),
            frequency_preset_desc: preset_desc.into(),
            values: FrequencyModel{ freq1, freq2, freq3: freq3_csv },
            ..Default::default()
        })
    }

    // pub fn create_preset(&self, preset_name: &str, preset_desc: &str, freq1: f32, freq2: f32, freq3: Vec<f32>) {
    pub fn create_preset(&self, preset: mvc::FrequencyPresetModel) {
...
impl FrequencyPresetModel {
    ...
    // }
    fn get_preset(&self, index: usize) -> Option<mvc::FrequencyPresetModel> {
    ...
    fn update_preset(&self, index: usize, preset: mvc::FrequencyPresetModel) {
        if !self.repo.update_frequency_preset(index, preset) {
            return;
        }
        self.notify.row_changed(index);
    }
    fn push_preset(&self, preset: mvc::FrequencyPresetModel) {
...
impl Model for FrequencyPresetModel {
    type Data = mvc::FrequencyPresetModel;
...
mod tests {
    ...
    fn frequency_preset1() -> mvc::FrequencyPresetModel {
        let frequency1 = FrequencyModel{freq1: 1.1, freq2: 1.1, freq3: vec![1.1]};
        let frequency_preset1 = mvc::FrequencyPresetModel{frequency_preset_name: "frequency1".into(), frequency_preset_desc: "desc".into(), values: frequency1 };
        frequency_preset1
    }
    fn frequency_preset2() -> mvc::FrequencyPresetModel {
        let frequency2 = FrequencyModel{freq1: 2.2, freq2: 2.2, freq3: vec![2.2]};
        let frequency_preset2 = mvc::FrequencyPresetModel{frequency_preset_name: "frequency2".into(), frequency_preset_desc: "desc".into(), values: frequency2 };
        frequency_preset2
    }
    fn frequency_preset3() -> mvc::FrequencyPresetModel {
        let frequency3 = FrequencyModel{freq1: 3.3, freq2: 3.3, freq3: vec![3.3]};
        let frequency_preset3 = mvc::FrequencyPresetModel{frequency_preset_name: "frequency3".into(), frequency_preset_desc: "desc".into(), values: frequency3 };
        frequency_preset3
    }
