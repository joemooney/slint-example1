...
impl PowerPresetListController {
    ...
    pub fn preset_model(&self) -> ModelRc<mvc::PowerPresetModel> {
    ...
    pub fn get_preset(&self, index: usize) -> Option<mvc::PowerPresetModel> {
    ...
    //     self.preset_model.update_preset(index, mvc::PowerPresetModel {
    //         power_preset_name: preset_name.into(),
    //         power_preset_desc: preset_desc.into(),
    //         values: PowerModel{ power1, power2, power3, power4, power5, power6, power7, power8, power9, power10 },
    //         ..Default::default()
    //     })
    // }

    pub fn update_preset(&self, index: usize, preset: mvc::PowerPresetModel) {
        println!("controllers/power_preset_list_controller:create_preset");
        // let preset_id = self.preset_model.
    ...
    //     println!("controllers/power_preset_list_controller:create_preset");
    //     // let preset_id = self.preset_model.
    //     self.preset_model.push_preset(mvc::PowerPresetModel {
    //         power_preset_name: preset_name.into(),
    //         power_preset_desc: preset_desc.into(),
    //         values: PowerModel{ power1, power2, power3, power4, power5, power6, power7, power8, power9, power10 },
    //         ..Default::default()
    //     })
    // }
    pub fn create_preset(&self, preset: mvc::PowerPresetModel) {
        println!("controllers/power_preset_list_controller:create_preset");
        // let preset_id = self.preset_model.
...
impl PowerPresetModel {
    ...
    fn get_preset(&self, index: usize) -> Option<mvc::PowerPresetModel> {
    ...
    fn update_preset(&self, index: usize, preset: mvc::PowerPresetModel) {
    ...
    fn push_preset(&self, preset: mvc::PowerPresetModel) {
...
impl Model for PowerPresetModel {
    type Data = mvc::PowerPresetModel;
...
mod tests {
    ...
    fn power_preset1() -> mvc::PowerPresetModel {
        let power1 = mvc::PowerModel{power1: 1.1, power2: 1.2, power3: 3.2, power4: 1.1, power5: 1.1, power6: 1.1, power7: 1.1, power8: 1.1, power9: 1, power10: 1};
        let power_preset1 = mvc::PowerPresetModel{power_preset_name: "power1".into(), power_preset_desc: "desc".into(), values: power1 };
        power_preset1
    }
    fn power_preset2() -> mvc::PowerPresetModel {
        let power2 = mvc::PowerModel{power1: 2.2, power2: 2.2, power3: 3.2, power4: 2.2, power5: 2.2, power6: 2.2, power7: 2.2, power8: 2.2, power9: 2, power10: 2};
        let power_preset2 = mvc::PowerPresetModel{power_preset_name: "power2".into(), power_preset_desc: "desc".into(), values: power2 };
        power_preset2
    }
    fn power_preset3() -> mvc::PowerPresetModel {
        let power3 = mvc::PowerModel{power1: 3.3, power2: 3.3, power3: 3.3, power4: 3.3, power5: 3.3, power6: 3.3, power7: 3.3, power8: 3.3, power9: 3, power10: 3};
        let power_preset3 = mvc::PowerPresetModel{power_preset_name: "power3".into(), power_preset_desc: "desc".into(), values: power3 };
        power_preset3
    }
