...
pub fn task_repo() -> impl traits::TaskRepository + Clone {
    MockTaskRepository::new(vec![
        TaskModel { title: "Learn Rust".into(), done: true, due_date: 1717686537151, priority: "low".into() },
        TaskModel { title: "Learn Slint".into(), done: true, due_date: 1717686537151, priority: "low".into() },
        TaskModel {
